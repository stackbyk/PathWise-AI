      ...
      >
        {mobile ? (
          ...
          <>
            <Sun
              size={16}
              className={isDark ? "text-slate-500" : "text-amber-500"}
            />
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {user ? (
              <div className="relative">
                <button
                  ...
                  "
                >
                  <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-full bg-primary-600 text-white shadow-sm">
                    {user?.photoURL ? (
                      <img
                        src={user.photoURL}
                        alt={displayName}
                  ...
                  <div className="hidden text-left xl:block">
                    <p className="max-w-[130px] truncate text-sm font-semibold text-slate-800 dark:text-slate-200">
                      {displayName}
                    </p>
        ...
        {mobileMenuOpen && (
          <div className="border-t border-slate-100 py-4 dark:border-slate-800 lg:hidden">
            <ThemeToggle mobile />

            {user ? (
              <div className="mt-3 space-y-1">
                <div className="mb-3 rounded-xl bg-slate-50 px-3 py-4 dark:bg-slate-900">
                  <div className="flex items-center gap-3">
