...
function Gamification() {
  ...
  const levelProgress = Math.min(Math.round((currentLevelXP / 250) * 100), 100);
  ...
  const completeMission = (mission) => {
    ...
    if (mission.id === 3) {
      setCompletedSkills((current) => current + 2);
    }
        ...
        <section className="game-card level-card">
          <div className="section-heading">
            <div>
              ...
              <p>{250 - currentLevelXP} XP remaining until your next level.</p>
            </div>
